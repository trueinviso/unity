# Explicitly require application controller because of
# ancestor chain constant lookup issues:
# https://github.com/rails/rails/issues/12168
require_dependency 'unity/application_controller'
...
module Unity
  ...
  def validate_user
    ...
    if current_user.gateway_customer.gateway_id.blank?
      raise Errors::NoGatewayCustomerId
    end
  end
